...
namespace SAMLPortal.Misc
{
	public class ApplyPolicyOrAuthorizeFilter : AuthorizeFilter
	{
		...
		public ApplyPolicyOrAuthorizeFilter(IAuthorizationPolicyProvider policyProvider, IEnumerable<IAuthorizeData> authorizeData) : base(policyProvider, authorizeData) { }
